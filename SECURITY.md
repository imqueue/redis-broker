...
> **Already known and deliberate:** the UDP broker-discovery channel is
> unauthenticated. That is a design decision with controls attached, not an
> undisclosed weakness — read [THREAT-MODEL.md](./THREAT-MODEL.md) before
> reporting it, and before deploying this outside a namespace you trust.
